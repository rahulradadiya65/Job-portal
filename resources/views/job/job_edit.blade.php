...
@section('content')
		...
		<div class="container">
			<div class="breadcrumb-section">
				...
				<h2 class="title">Edit your job</h2>
                                @if($errors->all())
			...
			<div class="job-postdetails">
				<div class="row">	
					<div class="col-md-8">
                        ...
                        <input type="hidden" value="{{ encrypt($jobdata->jobs_id) }}" name="jobs_id">
                        ...
                        <fieldset>
                            <div class="section postdetails">
                                ...
                                <div class="row form-group add-title">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="categories_id" value="{{ old('categories_id') }}" id="categories_id" class="form-control input-lg dynamic" >
                                            <option value="{{$jobdata->categories_id}}">{{$jobdata->category->category_name}}</option>
                                ...
                                <div class="row form-group add-title">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="jobs_types_id" value="{{ old('jobs_types_id') }}" id="jobs_types_id" class="form-control input-lg dynamic" >
                                            <option value="{{ $jobdata->jobs_types_id }}">{{ $jobdata->jobs_types->jobs_types }}</option>
                                ...
                                <div class="row form-group add-title">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="industry_id" value="{{ old('industry_id') }}" id="industry_id" class="form-control input-lg dynamic" >
                                            <option value="{{ $jobdata->industry_id }}">{{ $jobdata->industry->industry_name}}</option>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="jobs_title" type="text" value="{{$jobdata->jobs_title }}" class="form-control" id="jobs_title" placeholder="ex, Human Resource Manager">
                                    </div>
                                </div>					
                                <div class="row form-group item-description">
                                    <label class="col-sm-3 label-title">Description<span class="required">*</span></label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control summernote" name="description"  id="description" placeholder="Write few lines about your jobs" rows="8">{{ old('description') }}{{$jobdata->description}}</textarea>		
                                ...
                                <div class="row form-group add-title location">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="dropdown pull-left col-sm-6">
                                            <select name="state" value="state_id" class="form-control" id="state">
                                                <option value="{{ $jobdata->states_id }}">{{ $jobdata->state->state }}</option>
                                        ...
                                        <div class="dropdown pull-right col-sm-6">
                                            <select name="city" value="cities_id" class="form-control" id="city">
                                                <option value="{{ $jobdata->cities_id }}">{{ $jobdata->city->city }}</option>
                                            </select>								
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group select-price">
                                    ...
                                    <div class="col-sm-9">
                                        <label>&#x20b9;</label>
                                        <input name="minimum_salary" value="{{ $jobdata->minimum_salary }}" id="minimum_salary" type="text" class="form-control" placeholder="Min">
                                        <span>-</span>
                                        <input name="maximum_salary" type="text" value="{{ $jobdata->maximum_salary }}" id="maximum_salary" class="form-control" placeholder="Max">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="dropdown">
                                            <select name="salary_types_id" value="{{ old('salary_types_id') }}" class="form-control" id="salary_types_id">
                                                <option value="{{ $jobdata->salary_types_id }}">{{ $jobdata->salary_type->salary_types }}</option>
                                ...
                                <div class="row form-group select-price">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="minimum_experience" type="text" value="{{ $jobdata->minimum_experience }}" id="minimum_experience" class="form-control" placeholder="Min Year">

                                        <input name="maximum_experience" id="maximum_experience" type="text" value="{{ $jobdata->maximum_experience }}" class="form-control" placeholder="Max Year">
                                ...
                                <div class="row form-group brand-name">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="skills" value="{{ $jobdata->skills }}"id="skills" class="form-control" />
